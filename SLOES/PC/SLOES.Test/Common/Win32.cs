...
namespace KST
{
    ...
    public class Win32
    {
        ...
        // 自定义Windows消息
        public static readonly int WM_SHOW_FRAME = RegisterWindowMessage("WM_SHOW_FRAME");      // 重复运行时显示主窗体消息
        public static readonly int WM_CHANGE_SKIN = RegisterWindowMessage("WM_CHANGE_SKIN");    // 更换窗体皮肤消息
